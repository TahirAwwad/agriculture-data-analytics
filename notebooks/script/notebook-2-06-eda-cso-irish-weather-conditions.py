...
area_farmed_dataframe = pandas.read_csv('./../assets/cso-aqa06-area-farmed-in-june-2013-2021.csv')
fert_dataframe = pandas.read_csv('./../assets/cso-ajm05-fertiliser-price.csv')
land_cover_dataframe = pandas.read_csv('./../assets/cso-gca02-clc-land-cover-change-2012-2018.csv')


rainfall_dataframe = pandas.read_csv('./../assets/cso-mtm01-rainfall-1958-2021.csv')
sunshine_dataframe = pandas.read_csv('./../assets/cso-mtm03-sunshine-1958-2021.csv')
temperature_dataframe = pandas.read_csv('./../assets/cso-mtm02-temperature-1958-2021.csv')
